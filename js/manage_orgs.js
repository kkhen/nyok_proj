    ...
    recordsToShow.forEach(org => {
        tbody.innerHTML += `
            <tr>
                <td>${org.org_name}</td>
                <td>
                    <button class="btn-text editOrg" data-id="${org.id}" data-name="${org.org_name}" style="color: #6b7280; margin-right: 12px; font-weight: 600;">
                        EDIT
                    </button>
                    <button class="btn-text btn-text-danger deleteOrg" data-id="${org.id}" data-name="${org.org_name}">
                        DELETE
                    </button>
                </td>
            </tr>
